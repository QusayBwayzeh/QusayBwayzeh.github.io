...
if ($('body').hasClass('tt-dark-style')) {
	$('link[href="css/dark-style.css"]').prop( "disabled", false );
} else {
	$('link[href="css/dark-style.css"]').prop( "disabled", true );
}
...
if ($('body').hasClass('tt-rtl')) {
	...
	$('head').append($('<link rel="stylesheet" href="vendor/bootstrap/css/bootstrap-rtl/bootstrap-rtl.min.css">'));
	$('head').append($('<link rel="stylesheet" href="css/rtl/theme-rtl.css">'));
	$('head').append($('<link rel="stylesheet" href="css/rtl/helper-rtl.css">'));
}
...
if ($('body').hasClass('tt-round')) {
	$('link[href="css/round-style.css"]').prop( "disabled", false );
} else {
	$('link[href="css/round-style.css"]').prop( "disabled", true );
}
